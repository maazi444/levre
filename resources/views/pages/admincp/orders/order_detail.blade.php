...
@section('title', 'Order Details - Levre')
...
<div class="order_detail__outer">
    ...
    <div class="order_detail__col order_detail__border">
        ...
        <div class="detail_action">
            @if($orderRecord[0]['status'] == 1)
            <a href="{{ route('admin.order.process', $ordernum) }}" class="detail_action_btn">Process Order</a>
            @else
            <a class="detail_action_btn_disabled">Order Processed</a>
            @endif
        </div>
    </div>
    <!-- Left Column End -->
